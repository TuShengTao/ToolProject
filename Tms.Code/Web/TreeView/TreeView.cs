...
namespace Tms.Code
{
    ...
    {
        // 自己定义的 Tree
        public static string SelfTreeViewJson(this List<TreeViewModel> data, string parentId = "0")
        {
            ...
            if (item.Count > 0)
            {
                foreach (TreeViewModel entity in item)
                {
                    ...
                    strJson.Append("\"label\":\"" + entity.text.Replace("&nbsp;", "") + "\",");
                    ...
                    {
                        strJson.Append("\"parentnodId\":\"" + entity.parentId + "\",");
                    }
                    ...
                    strJson.Append("\"children\":" + SelfTreeViewJson(data, entity.id) + "");
                    strJson.Append("},");
                }
